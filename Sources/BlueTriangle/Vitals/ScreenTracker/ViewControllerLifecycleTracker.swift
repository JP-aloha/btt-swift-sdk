...
extension UIViewController{
    ...
    static func setUp() {
        lock.sync {
            ...
            if let sendActionPair = swizzleMethod(UIApplication.self, original: #selector(UIApplication.sendAction(_:to:from:for:)), swizzled: #selector(UIApplication.btt_sendAction(_:to:from:for:))) {
