...
class TimerMapActivity {
    ...
    private func updateTrackingTimer(loadTime: Millisecond, viewTime: Millisecond, disapearTime: Millisecond) {
        ...
        timer.nativeAppProperties = NativeAppProperties(
            ...
            hitchTimePercent: timer.responsivenessReport?.hitchTimePercent ?? 0,
            ...
            hangFramePercent: timer.responsivenessReport?.hangFramePercent ?? 0,
            hangTimePercent: timer.responsivenessReport?.hangTimePercent ?? 0,
